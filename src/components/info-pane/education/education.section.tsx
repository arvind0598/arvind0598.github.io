  ...
  <Box fill>
    ...
    <Box width={isDesktop ? '80%' : '100%'}>
      <Paragraph style={getParagraphStyles(isDesktop)} fill>
        I graduated from Manipal Institute of Technology (Manipal) with a Bachelor&apos;s degree in
      ...
      <Paragraph style={getParagraphStyles(isDesktop)} fill>
        ...
        multiple college fests, leading a batch of 15-20 students.
      </Paragraph>
      <Paragraph style={getParagraphStyles(isDesktop)} fill>
        I also mentored, then served as General Secretary and Academic Head for Teach Code for Good.
        TCfG is a non-profit initiative to teach basic computer knowledge and programming to
        underprivileged children.
      </Paragraph>
      <Paragraph style={getParagraphStyles(isDesktop)} fill>
        I have also been an active participant in the photography and computer science clubs and the
